...
local exiftool = require 'leaf500.ExiftoolBuilder'
local FilmShotsMetadata = require 'leaf500.FilmShotsMetadata'
...
function testBasic_Win()
    ...
    withGlobal ({
            {"WIN_ENV", true},
            {"_PLUGIN", {path = "c:\\Program Files\\Lightroom\\plugins\\filmlog.lrplugin"}}
        },
        function ()
            local builder = exiftool.make (DefaultMetadataMap)    
    ...
    lu.assertEquals(
        command,
        '"' ..
        '"c:\\Program Files\\Lightroom\\plugins\\filmlog.lrplugin\\exiftool\\windows\\exiftool.exe" ' ..
        '-Title="Roll 1" ' ..
        '-Caption="Seaside" ' ..
        '-UserComment="Comment comment comment" ' .. 
        '-Make="Kodak Gold" ' ..
...
function testBasic_Mac()
    ...
    withGlobal ({
            {"MAC_ENV", true},
            {"_PLUGIN", {path = "/Applications/Adobe Photoshop Lightroom 5.app/Contents/PlugIns/filmlog.lrplugin"}}
        },
        function ()
            local builder = exiftool.make (DefaultMetadataMap)    
            command = builder:buildCommand ("1.jpg", meta)       
    ...
    lu.assertEquals(
        command,
        '"/Applications/Adobe Photoshop Lightroom 5.app/Contents/PlugIns/filmlog.lrplugin/exiftool/macos/exiftool" ' ..
        '-Title="Roll 1" ' ..
        '-Caption="Seaside" ' ..
        '-UserComment="Comment comment comment" ' .. 
        '-Make="Kodak Gold" ' ..
